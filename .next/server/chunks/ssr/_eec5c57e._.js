...
"[project]/app/dashboard/products/delete-product-button.tsx [app-rsc] (ecmascript)": (function(__turbopack_context__) {
...
async function getProducts() {
    try {
        ...
        const response = await fetch(`${process.env.API_URL}/api/admin/products` || "http://localhost:3000/api/admin/products", {
            headers: {
...
//# sourceMappingURL=_eec5c57e._.js.map