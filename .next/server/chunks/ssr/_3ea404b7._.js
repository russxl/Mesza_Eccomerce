...
async function getProductById(slug) {
    ...
    // This could be a direct database query or API call
    try {
        // Example: using fetch to call your own API
...
async function ProductDetailPage(context) {
    ...
    const product = await __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$productStore$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useProductStore"].getState().fetchProductById(slug);
...
//# sourceMappingURL=_3ea404b7._.js.map